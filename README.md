...
> Este documento visa simular uma situação real para coleta de dados jurídicos através de informações públicas a partir de sistemas externos (Ex.: Tribunais). O
...
- Instalar Requerimentos `<Bibliotecas listadas no requeriments.txt>`
